...
(function (HyperZdHelpers) {
    ...
    HyperZdHelpers.setReady = setReady;
    /**
    ...
    HyperZdHelpers.setStage = setStage;
    /**
    ...
    HyperZdHelpers.after = after;
})(HyperZdHelpers || (HyperZdHelpers = {}));
class HyperZdHelpersLib extends Lib {
    icon = "/assets/icons/generic.svg";
    package = "anura.daemon.helpers";
    name = "HyperZd Helpers";
    versions = {
        "0.1.0": HyperZdHelpers,
    };
    latestVersion = "0.1.0";
...
//# sourceMappingURL=HyperZdHelpersLib.js.map