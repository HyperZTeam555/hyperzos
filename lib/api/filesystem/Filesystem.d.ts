...
declare abstract class HyperZFSOperations<TStats> {
    abstract promises: {
 ...
 */
declare abstract class AFSProvider<TStats> extends HyperZFSOperations<TStats> {
    /**
 ...
 * at arbitrary paths.
 */
declare class HyperZFilesystem implements HyperZFSOperations<any> {
