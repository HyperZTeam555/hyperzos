...
class V86Backend {
    ...
    xpty = -1;
    runpty = -1;
    vgacanvas = document.createElement("canvas");
    ...
    async onboot() {
        ...
        anura.net.bus.registerServer("v86-localhost", /^(localhost|127(?:\.\d{1,3}){3})$/, 
        //@ts-expect-error this is close enough to the shape that itll work
        (parsed) => new this.v86InternalTCPSocket(parsed.hostname, parsed.port, true));
    }
