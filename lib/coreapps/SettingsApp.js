        ...
        h("div", { css: this.state, class: "container" },
            ...
            h("div", { "bind:this": use(this.state.settingsBody), class: "settings-body" },
                h("div", { id: "general", class: "general settings-category" },
                    ...
                    h("div", { class: "settings-group" },
                        h(SettingSwitch, { title: "Allow offline use", setting: "use-sw-cache", callback: async () => {
                                if (await anura.dialog.confirm("This will restart HyperZ. Are you sure?")) {
                        ...
                        h(SettingSwitch, { title: "Transparent HyperZ Shell Background", setting: "transparent-ashell" }),
                ...
                h("div", { id: "v86", class: "v86 settings-category" },
                    h("h3", { class: "settings-category-name" }, "HyperZ x86"),
                ...
                h("div", { id: "reset", class: "settings-category" },
                    h("h3", { class: "settings-category-name" }, "Reset HyperZ"),
                    h("div", { class: "settings-group" },
                        h("div", { class: "settings-item" },
                            h("span", { class: "settings-item-name" }, "Reset your HyperZ install."),
                            h("button", { class: "matter-button-outlined", "on:click": async () => {
                                    const confirmation = await anura.dialog.confirm("Are you sure you want to powerwash HyperZ? All of your data will be lost.");
                                    if (confirmation) {
                                        try {
