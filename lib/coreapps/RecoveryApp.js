...
class RecoveryApp extends App {
    ...
    page = async () => (h("div", { class: this.css },
        ...
        h("div", { class: "recovery-app-content" },
            h("button", { style: "background: #B71C1C;", class: "matter-button-contained", title: "Reset your HyperZ install to factory settings. This will delete all of your data.", "on:click": async () => {
                    if (await anura.dialog.confirm("Are you sure you want to powerwash HyperZ? All of your data will be lost.")) {
                        try {
