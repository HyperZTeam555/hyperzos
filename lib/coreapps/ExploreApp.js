...
class ExploreApp extends App {
    ...
    whatsnew = (h("div", { id: "body" },
        h("h1", null,
            "What's new in HyperZOS 4 ",
            anura.version.pretty,
            "?"),
        h("p", null, "This version resolves a bug where certain portions of the OOBE were displayed incorrectly. The release notes for HyperZOS 4 2.1.0 continue below."),
        h("h2", null, "Experimental OPFS filesystem driver"),
        h("p", null,
            "HyperZOS 4 2.1 includes an experimental filesystem driver for the Origin Private File System (OPFS). This greatly improves the speed of file operations. You can enable it in",
            " ",
            h("span", null,
        ...
        h("p", null,
            "HyperZOS 4 2.1 is the first version to include support for Visual Studio Code. You can download it from the Developer Repository in",
            " ",
            h("span", null,
    ...
    v86 = () => (h("div", { id: "body", class: "v86" },
        ...
        h("p", null,
            "HyperZOS 4 includes an x86 subsystem (based on",
            " ",
            ...
            "), which lets you run real Linux within HyperZ.",
    ...
    welcome = (h("div", { id: "body" },
        h("div", { class: "head" },
            h("img", { src: "/icon.png", alt: "HyperZOS 4 Logo" }),
            h("h1", null, "Welcome to HyperZOS 4!")),
        h("h2", null, "What is HyperZOS 4?"),
        h("p", null, "HyperZOS 4 is a desktop environment made for development that runs right in your browser. It features full Linux emulation and a robust app ecosystem."),
        h("h2", null, "Getting Started"),
        h("p", null, "HyperZOS 4 functions just like your average desktop: you can launch apps from the launcher (accessible via the button in the bottom-left, or pressing the Meta key), drag windows around, and pin apps to the taskbar. HyperZOS 4 is visually based off of Google's ChromeOS."),
        h("h2", null, "Get new apps"),
        h("p", null,
            "To install more native HyperZ apps, you can head to the",
            " ",
            h("span", null,
                h("img", { src: "/apps/marketplace.app/playstore.webp", alt: "Marketplace Icon" }),
                h("a", { href: "javascript:anura.apps['anura.store'].open();" }, "Marketplace"),
        ...
        h("p", null,
            "HyperZOS 4 has robust customization features. You can change the wallpaper and system colors using",
            " ",
            h("span", null,
                h("a", { href: "javascript:anura.apps['anura.wallpaper'].open();" },
                    ...
                    "Wallpaper & Style")),
            "."),
        h("p", null, "For advanced users, HyperZ will execute any files in the /usr/init folder as JavaScript code on boot.")));
    state = $state({
        screen: this.welcome,
    });
