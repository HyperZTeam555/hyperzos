    ...
    page = () => (h("div", { class: "aboutapp-container" },
        ...
        h("div", { class: "aboutapp-content" },
            ...
            $if(anura.settings.get("x86-disabled"), h("p", null,
                ...
                "."), h("p", null, "HyperZ x86 subsystem enabled.")),
            h("br", null),
            $if(anura.settings.get("bootFromOPFS"), h("p", null, "HyperZ is booting from OPFS."), h("p", null, "HyperZ OPFS boot disabled.")),
            h("br", null),
            h("br", null),
            h("p", null,
