...
class ShortcutApp extends App implements HyperZShortcut {
	static async launchShortcut(props: HyperZShortcut) {
	...
	console = false;
	command =
		'/usr/bin/vista.ajs --alert --message "HyperZ Shortcuts: This shortcut is not configured properly." --title Error';
