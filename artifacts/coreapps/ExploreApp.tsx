class ExploreApp extends App {
	...
	whatsnew = (
		<div id="body">
			<h1>What's new in HyperZOS 4 {anura.version.pretty}?</h1>
			<p>
				This version resolves a bug where certain portions of the OOBE were
				displayed incorrectly. The release notes for HyperZOS 4 2.1.0 continue
				below.
			</p>
			<h2>Experimental OPFS filesystem driver</h2>
			<p>
				HyperZOS 4 2.1 includes an experimental filesystem driver for the Origin
			...
			<p>
				HyperZOS 4 2.1 is the first version to include support for Visual Studio
	...
	welcome = (
		<div id="body">
			<div class="head">
				<img src="/icon.png" alt="HyperZOS 4 Logo" />
				<h1>Welcome to HyperZOS 4!</h1>
			</div>
			<h2>What is HyperZOS 4?</h2>
			<p>
				HyperZOS 4 is a desktop environment made for development that runs right in
				your browser. It features full Linux emulation and a robust app
				ecosystem.
			</p>
			<h2>Getting Started</h2>
			<p>
				HyperZOS 4 functions just like your average desktop: you can launch apps
				...
				taskbar. HyperZOS 4 is visually based off of Google's ChromeOS.
			</p>
			...
			<p>
				HyperZOS 4 has robust customization features. You can change the wallpaper
			...
			<p>
				For advanced users, HyperZ will execute any files in the /usr/init folder
