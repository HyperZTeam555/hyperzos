				...
				<div bind:this={use(this.state.settingsBody)} class="settings-body">
					<div id="general" class="general settings-category">
						...
						<div class="settings-group">
								...
								callback={async () => {
									if (
										await anura.dialog.confirm(
											"This will restart HyperZ. Are you sure?",
										)
									) {
							...
							/>
							<SettingSwitch
								title="Transparent HyperZ Shell Background"
					...
					<div id="v86" class="v86 settings-category">
						<h3 class="settings-category-name">HyperZ x86</h3>
						<div class="settings-group">
					...
					<div id="reset" class="settings-category">
						<h3 class="settings-category-name">Reset HyperZ</h3>
						<div class="settings-group">
							<div class="settings-item">
								<span class="settings-item-name">
									Reset your HyperZ install.
								</span>
								<button
									class="matter-button-outlined"
									on:click={async () => {
										const confirmation = await anura.dialog.confirm(
											"Are you sure you want to powerwash HyperZ? All of your data will be lost.",
										);
										if (confirmation) {
											try {
