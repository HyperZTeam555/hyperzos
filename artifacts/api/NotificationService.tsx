class NotificationService {
	...
	add(params: NotifParams) {
		const notif = new HyperZNotification(params, () => {
			this.remove(notif);
		});
	...
	remove(notification: HyperZNotification, rendererOnly = false) {
		if (!rendererOnly) {
	...
	subscribe(callback: (notifications: HyperZNotification[]) => void) {
		let active = true;
...
class HyperZNotification implements NotifParams {
	title = "HyperZ Notification";
	description = "HyperZ Description";
