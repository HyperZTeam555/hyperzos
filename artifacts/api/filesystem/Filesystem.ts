...
abstract class HyperZFSOperations<TStats> {
	/*
 ...
 */
abstract class AFSProvider<TStats> extends HyperZFSOperations<TStats> {
	/**
 ...
 * at arbitrary paths.
 */
class HyperZFilesystem implements HyperZFSOperations<any> {
